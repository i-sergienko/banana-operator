 ...
 * Our Custom Resource.
 *
 * {@code implements CustomResource<BananaSpec, Void>} means that this is a custom resource,
 * with a {@code spec} field of type {@code BananaSpec},
 * and without a {@code status} field - hence {@code Void} as the second argument.
 *
...
public class Banana extends CustomResource<BananaSpec, Void> implements Namespaced {
}
